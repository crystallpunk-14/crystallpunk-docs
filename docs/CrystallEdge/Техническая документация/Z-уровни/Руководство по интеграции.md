...
- Почините все импорты, Убедитесь что ни в одном файле нет ошибок. Для этого придется добавить некоторые дополнительные поля в ванильные прототипы и компоненты.
    ...
    - `ContentTileDefinition` получил поле [Transparent](https://github.com/crystallpunk-14/crystall-edge/blob/ca1795d821637af1ba6faaf964ee598e020e1290/Content.Shared/Maps/ContentTileDefinition.cs#L134C63-L140C41), который нужно вручную проставить на true во все "прозрачные" тайлы в вашем проекте, [включая стандартные тайлы космоса](https://github.com/crystallpunk-14/crystall-edge/blob/bd5aaf45e5f71bd17cbd23cfbdf923cc92d2cec4/Resources/Prototypes/Tiles/space.yml#L8).
