...
- Почините все импорты, Убедитесь что ни в одном файле нет ошибок. Для этого придется добавить некоторые дополнительные поля в ванильные прототипы и компоненты.
    ...
    - [Ключ анимациивыносливости сделан публичным](https://github.com/crystallpunk-14/crystall-edge/blob/bd5aaf45e5f71bd17cbd23cfbdf923cc92d2cec4/Content.Client/Damage/Systems/StaminaSystem.cs#L18), чтобы анимация выносливости автоматически обновлялась под текущую высоту персонажа.
